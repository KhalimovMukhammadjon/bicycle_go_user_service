...
func (c *productServiceClient) GetById(ctx context.Context, in *PrimaryKeyProduct, opts ...grpc.CallOption) (*Product, error) {
	out := new(Product)
...
func (c *productServiceClient) Delete(ctx context.Context, in *PrimaryKeyProduct, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedProductServiceServer) GetById(context.Context, *PrimaryKeyProduct) (*Product, error) {
...
func _ProductService_GetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).GetById(ctx, req.(*PrimaryKeyProduct))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ProductService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).Delete(ctx, req.(*PrimaryKeyProduct))
	}
	return interceptor(ctx, in, info, handler)
}
