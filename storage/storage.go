...
type UserRepoI interface {
	...
	Login(ctx context.Context, req *user_service.LoginRequest) (*user_service.LoginResponse, error)
	Register(ctx context.Context, req *user_service.CreateUserRequest) (*user_service.RegisterResponse, error)
}
